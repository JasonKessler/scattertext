 ...
 * USAGE SUMMARY
 *     initialization:
 *         ds = new RectangleHolder();
 *     get # of entries:
 *         ds.size();
 *     add:
 *         ds.add(new Rectangle(ax1, ay1, ax2, ay2));
 *     remove:
 *         ds.remove(elem);
 *     update all fields:
 *         ds.update(elem, new_ax1, new_ay1, new_ax2, new_ay2);
 *     update ax1:
 *         ds.updateAx1(elem, new_ax1);
 *     update ay1:
 *         ds.updateAy1(elem, new_ay1);
 *     update ax2:
 *         ds.updateAx2(elem, new_ax2);
 *     update ay2:
 *         ds.updateAy2(elem, new_ay2);
 *     queries:
 *         ds.findMatchingRectangles(bx1, by1, bx2, by2, function(elem) { ... });
 * NOTE: Be careful not to add the same Rectangle object more than once.
 * NOTE: Be careful not to remove or update an entry that is not in the data structure.
 * NOTE: You may not make changes (add/remove/update) in query callbacks.
 * NOTE: Elements can be removed in-place during iteration: if your query callback returns a truthy value, then the element is removed.
 */
...
RectangleHolder.prototype.size = function() { return this.my_size; };
RectangleHolder.prototype.add = function(x) {
    ...
    var _old_height78 = (_cursor73)._height10;
     /* _min_ax12 is min of ax1 */ var _augval79 = (_cursor73).ax1;
    ...
    (_cursor73)._min_ax12 = _augval79;
     /* _min_ay13 is min of ay1 */ var _augval84 = (_cursor73).ay1;
    ...
    (_cursor73)._min_ay13 = _augval84;
     /* _max_ay24 is max of ay2 */ var _augval89 = (_cursor73).ay2;
    ...
    _cursor73 = (_cursor73)._parent9;
     ...
     /* rebalance AVL tree */ var _cursor94 = x;
    var _imbalance95;
    ...
    if ((((((_cursor94)._left7)._left7) == null) ? (-1) : ((((_cursor94)._left7)._left7)._height10)) < (((((_cursor94)._left7)._right8) == null) ? (-1) : ((((_cursor94)._left7)._right8)._height10))) {
     /* rotate ((_cursor94)._left7)._right8 */ var _a96 = (_cursor94)._left7;
    var _b97 = (_a96)._right8;
    var _c98 = (_b97)._left7;
     /* replace _a96 with _b97 in (_a96)._parent9 */ if (!(((_a96)._parent9) == null)) {
    ...
    (_b97)._parent9 = (_a96)._parent9;
     ...
     /* replace _c98 with _a96 in _b97 */ (_b97)._left7 = _a96;
    if (!((_a96) == null)) {
    (_a96)._parent9 = _b97;
    }
     /* replace _b97 with _c98 in _a96 */ (_a96)._right8 = _c98;
    if (!((_c98) == null)) {
    (_c98)._parent9 = _a96;
    }
     /* _min_ax12 is min of ax1 */ var _augval99 = (_a96).ax1;
    ...
    (_a96)._min_ax12 = _augval99;
     /* _min_ay13 is min of ay1 */ var _augval104 = (_a96).ay1;
    ...
    (_a96)._min_ay13 = _augval104;
     /* _max_ay24 is max of ay2 */ var _augval109 = (_a96).ay2;
    ...
    (_a96)._height10 = 1+((((((_a96)._left7) == null) ? (-1) : (((_a96)._left7)._height10)) > ((((_a96)._right8) == null) ? (-1) : (((_a96)._right8)._height10))) ? ((((_a96)._left7) == null) ? (-1) : (((_a96)._left7)._height10)) : ((((_a96)._right8) == null) ? (-1) : (((_a96)._right8)._height10)));
     /* _min_ax12 is min of ax1 */ var _augval114 = (_b97).ax1;
    ...
    (_b97)._min_ax12 = _augval114;
     /* _min_ay13 is min of ay1 */ var _augval119 = (_b97).ay1;
    ...
    (_b97)._min_ay13 = _augval119;
     /* _max_ay24 is max of ay2 */ var _augval124 = (_b97).ay2;
    ...
    if (!(((_b97)._parent9) == null)) {
     /* _min_ax12 is min of ax1 */ var _augval129 = ((_b97)._parent9).ax1;
    ...
    ((_b97)._parent9)._min_ax12 = _augval129;
     /* _min_ay13 is min of ay1 */ var _augval134 = ((_b97)._parent9).ay1;
    ...
    ((_b97)._parent9)._min_ay13 = _augval134;
     /* _max_ay24 is max of ay2 */ var _augval139 = ((_b97)._parent9).ay2;
    ...
    (this)._root1 = _b97;
     ...
     /* rotate (_cursor94)._left7 */ var _a144 = _cursor94;
    var _b145 = (_a144)._left7;
    var _c146 = (_b145)._right8;
     /* replace _a144 with _b145 in (_a144)._parent9 */ if (!(((_a144)._parent9) == null)) {
    ...
    (_b145)._parent9 = (_a144)._parent9;
     ...
     /* replace _c146 with _a144 in _b145 */ (_b145)._right8 = _a144;
    if (!((_a144) == null)) {
    (_a144)._parent9 = _b145;
    }
     /* replace _b145 with _c146 in _a144 */ (_a144)._left7 = _c146;
    if (!((_c146) == null)) {
    (_c146)._parent9 = _a144;
    }
     /* _min_ax12 is min of ax1 */ var _augval147 = (_a144).ax1;
    ...
    (_a144)._min_ax12 = _augval147;
     /* _min_ay13 is min of ay1 */ var _augval152 = (_a144).ay1;
    ...
    (_a144)._min_ay13 = _augval152;
     /* _max_ay24 is max of ay2 */ var _augval157 = (_a144).ay2;
    ...
    (_a144)._height10 = 1+((((((_a144)._left7) == null) ? (-1) : (((_a144)._left7)._height10)) > ((((_a144)._right8) == null) ? (-1) : (((_a144)._right8)._height10))) ? ((((_a144)._left7) == null) ? (-1) : (((_a144)._left7)._height10)) : ((((_a144)._right8) == null) ? (-1) : (((_a144)._right8)._height10)));
     /* _min_ax12 is min of ax1 */ var _augval162 = (_b145).ax1;
    ...
    (_b145)._min_ax12 = _augval162;
     /* _min_ay13 is min of ay1 */ var _augval167 = (_b145).ay1;
    ...
    (_b145)._min_ay13 = _augval167;
     /* _max_ay24 is max of ay2 */ var _augval172 = (_b145).ay2;
    ...
    if (!(((_b145)._parent9) == null)) {
     /* _min_ax12 is min of ax1 */ var _augval177 = ((_b145)._parent9).ax1;
    ...
    ((_b145)._parent9)._min_ax12 = _augval177;
     /* _min_ay13 is min of ay1 */ var _augval182 = ((_b145)._parent9).ay1;
    ...
    ((_b145)._parent9)._min_ay13 = _augval182;
     /* _max_ay24 is max of ay2 */ var _augval187 = ((_b145)._parent9).ay2;
    ...
    if ((((((_cursor94)._right8)._left7) == null) ? (-1) : ((((_cursor94)._right8)._left7)._height10)) > (((((_cursor94)._right8)._right8) == null) ? (-1) : ((((_cursor94)._right8)._right8)._height10))) {
     /* rotate ((_cursor94)._right8)._left7 */ var _a192 = (_cursor94)._right8;
    var _b193 = (_a192)._left7;
    var _c194 = (_b193)._right8;
     /* replace _a192 with _b193 in (_a192)._parent9 */ if (!(((_a192)._parent9) == null)) {
    ...
    (_b193)._parent9 = (_a192)._parent9;
     ...
     /* replace _c194 with _a192 in _b193 */ (_b193)._right8 = _a192;
    if (!((_a192) == null)) {
    (_a192)._parent9 = _b193;
    }
     /* replace _b193 with _c194 in _a192 */ (_a192)._left7 = _c194;
    if (!((_c194) == null)) {
    (_c194)._parent9 = _a192;
    }
     /* _min_ax12 is min of ax1 */ var _augval195 = (_a192).ax1;
    ...
    (_a192)._min_ax12 = _augval195;
     /* _min_ay13 is min of ay1 */ var _augval200 = (_a192).ay1;
    ...
    (_a192)._min_ay13 = _augval200;
     /* _max_ay24 is max of ay2 */ var _augval205 = (_a192).ay2;
    ...
    (_a192)._height10 = 1+((((((_a192)._left7) == null) ? (-1) : (((_a192)._left7)._height10)) > ((((_a192)._right8) == null) ? (-1) : (((_a192)._right8)._height10))) ? ((((_a192)._left7) == null) ? (-1) : (((_a192)._left7)._height10)) : ((((_a192)._right8) == null) ? (-1) : (((_a192)._right8)._height10)));
     /* _min_ax12 is min of ax1 */ var _augval210 = (_b193).ax1;
    ...
    (_b193)._min_ax12 = _augval210;
     /* _min_ay13 is min of ay1 */ var _augval215 = (_b193).ay1;
    ...
    (_b193)._min_ay13 = _augval215;
     /* _max_ay24 is max of ay2 */ var _augval220 = (_b193).ay2;
    ...
    if (!(((_b193)._parent9) == null)) {
     /* _min_ax12 is min of ax1 */ var _augval225 = ((_b193)._parent9).ax1;
    ...
    ((_b193)._parent9)._min_ax12 = _augval225;
     /* _min_ay13 is min of ay1 */ var _augval230 = ((_b193)._parent9).ay1;
    ...
    ((_b193)._parent9)._min_ay13 = _augval230;
     /* _max_ay24 is max of ay2 */ var _augval235 = ((_b193)._parent9).ay2;
    ...
    (this)._root1 = _b193;
     ...
     /* rotate (_cursor94)._right8 */ var _a240 = _cursor94;
    var _b241 = (_a240)._right8;
    var _c242 = (_b241)._left7;
     /* replace _a240 with _b241 in (_a240)._parent9 */ if (!(((_a240)._parent9) == null)) {
    ...
    (_b241)._parent9 = (_a240)._parent9;
     ...
     /* replace _c242 with _a240 in _b241 */ (_b241)._left7 = _a240;
    if (!((_a240) == null)) {
    (_a240)._parent9 = _b241;
    }
     /* replace _b241 with _c242 in _a240 */ (_a240)._right8 = _c242;
    if (!((_c242) == null)) {
    (_c242)._parent9 = _a240;
    }
     /* _min_ax12 is min of ax1 */ var _augval243 = (_a240).ax1;
    ...
    (_a240)._min_ax12 = _augval243;
     /* _min_ay13 is min of ay1 */ var _augval248 = (_a240).ay1;
    ...
    (_a240)._min_ay13 = _augval248;
     /* _max_ay24 is max of ay2 */ var _augval253 = (_a240).ay2;
    ...
    (_a240)._height10 = 1+((((((_a240)._left7) == null) ? (-1) : (((_a240)._left7)._height10)) > ((((_a240)._right8) == null) ? (-1) : (((_a240)._right8)._height10))) ? ((((_a240)._left7) == null) ? (-1) : (((_a240)._left7)._height10)) : ((((_a240)._right8) == null) ? (-1) : (((_a240)._right8)._height10)));
     /* _min_ax12 is min of ax1 */ var _augval258 = (_b241).ax1;
    ...
    (_b241)._min_ax12 = _augval258;
     /* _min_ay13 is min of ay1 */ var _augval263 = (_b241).ay1;
    ...
    (_b241)._min_ay13 = _augval263;
     /* _max_ay24 is max of ay2 */ var _augval268 = (_b241).ay2;
    ...
    if (!(((_b241)._parent9) == null)) {
     /* _min_ax12 is min of ax1 */ var _augval273 = ((_b241)._parent9).ax1;
    ...
    ((_b241)._parent9)._min_ax12 = _augval273;
     /* _min_ay13 is min of ay1 */ var _augval278 = ((_b241)._parent9).ay1;
    ...
    ((_b241)._parent9)._min_ay13 = _augval278;
     /* _max_ay24 is max of ay2 */ var _augval283 = ((_b241)._parent9).ay2;
...
RectangleHolder.prototype.remove = function(x) {
    ...
    _new_x291 = null;
     /* replace x with _new_x291 in _parent288 */ if (!((_parent288) == null)) {
    ...
    var _mr297 = (_x293)._right8;
     /* replace _x293 with _mr297 in _mp296 */ if (!((_mp296) == null)) {
    ...
    (_mr297)._parent9 = _mp296;
     ...
     /* replace x with _x293 in _parent288 */ if (!((_parent288) == null)) {
    if (((_parent288)._left7) == (x)) {
    ...
    (_x293)._parent9 = _parent288;
     ...
     /* replace null with _left289 in _x293 */ (_x293)._left7 = _left289;
    if (!((_left289) == null)) {
    (_left289)._parent9 = _x293;
    }
     /* replace _mr297 with (x)._right8 in _x293 */ (_x293)._right8 = (x)._right8;
    if (!(((x)._right8) == null)) {
    ((x)._right8)._parent9 = _x293;
    }
     /* _min_ax12 is min of ax1 */ var _augval298 = (_x293).ax1;
    ...
    (_x293)._min_ax12 = _augval298;
     /* _min_ay13 is min of ay1 */ var _augval303 = (_x293).ay1;
    ...
    (_x293)._min_ay13 = _augval303;
     /* _max_ay24 is max of ay2 */ var _augval308 = (_x293).ay2;
    ...
    var _old_height318 = (_cursor313)._height10;
     /* _min_ax12 is min of ax1 */ var _augval319 = (_cursor313).ax1;
    ...
    (_cursor313)._min_ax12 = _augval319;
     /* _min_ay13 is min of ay1 */ var _augval324 = (_cursor313).ay1;
    ...
    (_cursor313)._min_ay13 = _augval324;
     /* _max_ay24 is max of ay2 */ var _augval329 = (_cursor313).ay2;
    ...
    var _old_height339 = (_cursor334)._height10;
     /* _min_ax12 is min of ax1 */ var _augval340 = (_cursor334).ax1;
    ...
    (_cursor334)._min_ax12 = _augval340;
     /* _min_ay13 is min of ay1 */ var _augval345 = (_cursor334).ay1;
    ...
    (_cursor334)._min_ay13 = _augval345;
     /* _max_ay24 is max of ay2 */ var _augval350 = (_cursor334).ay2;
...
RectangleHolder.prototype.updateAx1 = function(__x, new_val) {
    if ((__x).ax1 != new_val) {
         /* _min_ax12 is min of ax1 */ var _augval355 = new_val;
        ...
        var _old_height363 = (_cursor360)._height10;
         /* _min_ax12 is min of ax1 */ var _augval364 = (_cursor360).ax1;
...
RectangleHolder.prototype.updateAy1 = function(__x, new_val) {
    if ((__x).ay1 != new_val) {
         /* _min_ay13 is min of ay1 */ var _augval369 = new_val;
        ...
        var _old_height377 = (_cursor374)._height10;
         /* _min_ay13 is min of ay1 */ var _augval378 = (_cursor374).ay1;
...
RectangleHolder.prototype.updateAx2 = function(__x, new_val) {
    if ((__x).ax2 != new_val) {
        ...
        _new_x386 = null;
         /* replace __x with _new_x386 in _parent383 */ if (!((_parent383) == null)) {
        ...
        var _mr392 = (_x388)._right8;
         /* replace _x388 with _mr392 in _mp391 */ if (!((_mp391) == null)) {
        ...
        (_mr392)._parent9 = _mp391;
         ...
         /* replace __x with _x388 in _parent383 */ if (!((_parent383) == null)) {
        if (((_parent383)._left7) == (__x)) {
        ...
        (_x388)._parent9 = _parent383;
         ...
         /* replace null with _left384 in _x388 */ (_x388)._left7 = _left384;
        if (!((_left384) == null)) {
        (_left384)._parent9 = _x388;
        }
         /* replace _mr392 with (__x)._right8 in _x388 */ (_x388)._right8 = (__x)._right8;
        if (!(((__x)._right8) == null)) {
        ((__x)._right8)._parent9 = _x388;
        }
         /* _min_ax12 is min of ax1 */ var _augval393 = (_x388).ax1;
        ...
        (_x388)._min_ax12 = _augval393;
         /* _min_ay13 is min of ay1 */ var _augval398 = (_x388).ay1;
        ...
        (_x388)._min_ay13 = _augval398;
         /* _max_ay24 is max of ay2 */ var _augval403 = (_x388).ay2;
        ...
        var _old_height413 = (_cursor408)._height10;
         /* _min_ax12 is min of ax1 */ var _augval414 = (_cursor408).ax1;
        ...
        (_cursor408)._min_ax12 = _augval414;
         /* _min_ay13 is min of ay1 */ var _augval419 = (_cursor408).ay1;
        ...
        (_cursor408)._min_ay13 = _augval419;
         /* _max_ay24 is max of ay2 */ var _augval424 = (_cursor408).ay2;
        ...
        var _old_height434 = (_cursor429)._height10;
         /* _min_ax12 is min of ax1 */ var _augval435 = (_cursor429).ax1;
        ...
        (_cursor429)._min_ax12 = _augval435;
         /* _min_ay13 is min of ay1 */ var _augval440 = (_cursor429).ay1;
        ...
        (_cursor429)._min_ay13 = _augval440;
         /* _max_ay24 is max of ay2 */ var _augval445 = (_cursor429).ay2;
        ...
        var _old_height458 = (_cursor453)._height10;
         /* _min_ax12 is min of ax1 */ var _augval459 = (_cursor453).ax1;
        ...
        (_cursor453)._min_ax12 = _augval459;
         /* _min_ay13 is min of ay1 */ var _augval464 = (_cursor453).ay1;
        ...
        (_cursor453)._min_ay13 = _augval464;
         /* _max_ay24 is max of ay2 */ var _augval469 = (_cursor453).ay2;
        ...
        _cursor453 = (_cursor453)._parent9;
         ...
         /* rebalance AVL tree */ var _cursor474 = __x;
        var _imbalance475;
        ...
        if ((((((_cursor474)._left7)._left7) == null) ? (-1) : ((((_cursor474)._left7)._left7)._height10)) < (((((_cursor474)._left7)._right8) == null) ? (-1) : ((((_cursor474)._left7)._right8)._height10))) {
         /* rotate ((_cursor474)._left7)._right8 */ var _a476 = (_cursor474)._left7;
        var _b477 = (_a476)._right8;
        var _c478 = (_b477)._left7;
         /* replace _a476 with _b477 in (_a476)._parent9 */ if (!(((_a476)._parent9) == null)) {
        ...
        (_b477)._parent9 = (_a476)._parent9;
         ...
         /* replace _c478 with _a476 in _b477 */ (_b477)._left7 = _a476;
        if (!((_a476) == null)) {
        (_a476)._parent9 = _b477;
        }
         /* replace _b477 with _c478 in _a476 */ (_a476)._right8 = _c478;
        if (!((_c478) == null)) {
        (_c478)._parent9 = _a476;
        }
         /* _min_ax12 is min of ax1 */ var _augval479 = (_a476).ax1;
        ...
        (_a476)._min_ax12 = _augval479;
         /* _min_ay13 is min of ay1 */ var _augval484 = (_a476).ay1;
        ...
        (_a476)._min_ay13 = _augval484;
         /* _max_ay24 is max of ay2 */ var _augval489 = (_a476).ay2;
        ...
        (_a476)._height10 = 1+((((((_a476)._left7) == null) ? (-1) : (((_a476)._left7)._height10)) > ((((_a476)._right8) == null) ? (-1) : (((_a476)._right8)._height10))) ? ((((_a476)._left7) == null) ? (-1) : (((_a476)._left7)._height10)) : ((((_a476)._right8) == null) ? (-1) : (((_a476)._right8)._height10)));
         /* _min_ax12 is min of ax1 */ var _augval494 = (_b477).ax1;
        ...
        (_b477)._min_ax12 = _augval494;
         /* _min_ay13 is min of ay1 */ var _augval499 = (_b477).ay1;
        ...
        (_b477)._min_ay13 = _augval499;
         /* _max_ay24 is max of ay2 */ var _augval504 = (_b477).ay2;
        ...
        if (!(((_b477)._parent9) == null)) {
         /* _min_ax12 is min of ax1 */ var _augval509 = ((_b477)._parent9).ax1;
        ...
        ((_b477)._parent9)._min_ax12 = _augval509;
         /* _min_ay13 is min of ay1 */ var _augval514 = ((_b477)._parent9).ay1;
        ...
        ((_b477)._parent9)._min_ay13 = _augval514;
         /* _max_ay24 is max of ay2 */ var _augval519 = ((_b477)._parent9).ay2;
        ...
        (this)._root1 = _b477;
         ...
         /* rotate (_cursor474)._left7 */ var _a524 = _cursor474;
        var _b525 = (_a524)._left7;
        var _c526 = (_b525)._right8;
         /* replace _a524 with _b525 in (_a524)._parent9 */ if (!(((_a524)._parent9) == null)) {
        ...
        (_b525)._parent9 = (_a524)._parent9;
         ...
         /* replace _c526 with _a524 in _b525 */ (_b525)._right8 = _a524;
        if (!((_a524) == null)) {
        (_a524)._parent9 = _b525;
        }
         /* replace _b525 with _c526 in _a524 */ (_a524)._left7 = _c526;
        if (!((_c526) == null)) {
        (_c526)._parent9 = _a524;
        }
         /* _min_ax12 is min of ax1 */ var _augval527 = (_a524).ax1;
        ...
        (_a524)._min_ax12 = _augval527;
         /* _min_ay13 is min of ay1 */ var _augval532 = (_a524).ay1;
        ...
        (_a524)._min_ay13 = _augval532;
         /* _max_ay24 is max of ay2 */ var _augval537 = (_a524).ay2;
        ...
        (_a524)._height10 = 1+((((((_a524)._left7) == null) ? (-1) : (((_a524)._left7)._height10)) > ((((_a524)._right8) == null) ? (-1) : (((_a524)._right8)._height10))) ? ((((_a524)._left7) == null) ? (-1) : (((_a524)._left7)._height10)) : ((((_a524)._right8) == null) ? (-1) : (((_a524)._right8)._height10)));
         /* _min_ax12 is min of ax1 */ var _augval542 = (_b525).ax1;
        ...
        (_b525)._min_ax12 = _augval542;
         /* _min_ay13 is min of ay1 */ var _augval547 = (_b525).ay1;
        ...
        (_b525)._min_ay13 = _augval547;
         /* _max_ay24 is max of ay2 */ var _augval552 = (_b525).ay2;
        ...
        if (!(((_b525)._parent9) == null)) {
         /* _min_ax12 is min of ax1 */ var _augval557 = ((_b525)._parent9).ax1;
        ...
        ((_b525)._parent9)._min_ax12 = _augval557;
         /* _min_ay13 is min of ay1 */ var _augval562 = ((_b525)._parent9).ay1;
        ...
        ((_b525)._parent9)._min_ay13 = _augval562;
         /* _max_ay24 is max of ay2 */ var _augval567 = ((_b525)._parent9).ay2;
        ...
        if ((((((_cursor474)._right8)._left7) == null) ? (-1) : ((((_cursor474)._right8)._left7)._height10)) > (((((_cursor474)._right8)._right8) == null) ? (-1) : ((((_cursor474)._right8)._right8)._height10))) {
         /* rotate ((_cursor474)._right8)._left7 */ var _a572 = (_cursor474)._right8;
        var _b573 = (_a572)._left7;
        var _c574 = (_b573)._right8;
         /* replace _a572 with _b573 in (_a572)._parent9 */ if (!(((_a572)._parent9) == null)) {
        ...
        (_b573)._parent9 = (_a572)._parent9;
         ...
         /* replace _c574 with _a572 in _b573 */ (_b573)._right8 = _a572;
        if (!((_a572) == null)) {
        (_a572)._parent9 = _b573;
        }
         /* replace _b573 with _c574 in _a572 */ (_a572)._left7 = _c574;
        if (!((_c574) == null)) {
        (_c574)._parent9 = _a572;
        }
         /* _min_ax12 is min of ax1 */ var _augval575 = (_a572).ax1;
        ...
        (_a572)._min_ax12 = _augval575;
         /* _min_ay13 is min of ay1 */ var _augval580 = (_a572).ay1;
        ...
        (_a572)._min_ay13 = _augval580;
         /* _max_ay24 is max of ay2 */ var _augval585 = (_a572).ay2;
        ...
        (_a572)._height10 = 1+((((((_a572)._left7) == null) ? (-1) : (((_a572)._left7)._height10)) > ((((_a572)._right8) == null) ? (-1) : (((_a572)._right8)._height10))) ? ((((_a572)._left7) == null) ? (-1) : (((_a572)._left7)._height10)) : ((((_a572)._right8) == null) ? (-1) : (((_a572)._right8)._height10)));
         /* _min_ax12 is min of ax1 */ var _augval590 = (_b573).ax1;
        ...
        (_b573)._min_ax12 = _augval590;
         /* _min_ay13 is min of ay1 */ var _augval595 = (_b573).ay1;
        ...
        (_b573)._min_ay13 = _augval595;
         /* _max_ay24 is max of ay2 */ var _augval600 = (_b573).ay2;
        ...
        if (!(((_b573)._parent9) == null)) {
         /* _min_ax12 is min of ax1 */ var _augval605 = ((_b573)._parent9).ax1;
        ...
        ((_b573)._parent9)._min_ax12 = _augval605;
         /* _min_ay13 is min of ay1 */ var _augval610 = ((_b573)._parent9).ay1;
        ...
        ((_b573)._parent9)._min_ay13 = _augval610;
         /* _max_ay24 is max of ay2 */ var _augval615 = ((_b573)._parent9).ay2;
        ...
        (this)._root1 = _b573;
         ...
         /* rotate (_cursor474)._right8 */ var _a620 = _cursor474;
        var _b621 = (_a620)._right8;
        var _c622 = (_b621)._left7;
         /* replace _a620 with _b621 in (_a620)._parent9 */ if (!(((_a620)._parent9) == null)) {
        ...
        (_b621)._parent9 = (_a620)._parent9;
         ...
         /* replace _c622 with _a620 in _b621 */ (_b621)._left7 = _a620;
        if (!((_a620) == null)) {
        (_a620)._parent9 = _b621;
        }
         /* replace _b621 with _c622 in _a620 */ (_a620)._right8 = _c622;
        if (!((_c622) == null)) {
        (_c622)._parent9 = _a620;
        }
         /* _min_ax12 is min of ax1 */ var _augval623 = (_a620).ax1;
        ...
        (_a620)._min_ax12 = _augval623;
         /* _min_ay13 is min of ay1 */ var _augval628 = (_a620).ay1;
        ...
        (_a620)._min_ay13 = _augval628;
         /* _max_ay24 is max of ay2 */ var _augval633 = (_a620).ay2;
        ...
        (_a620)._height10 = 1+((((((_a620)._left7) == null) ? (-1) : (((_a620)._left7)._height10)) > ((((_a620)._right8) == null) ? (-1) : (((_a620)._right8)._height10))) ? ((((_a620)._left7) == null) ? (-1) : (((_a620)._left7)._height10)) : ((((_a620)._right8) == null) ? (-1) : (((_a620)._right8)._height10)));
         /* _min_ax12 is min of ax1 */ var _augval638 = (_b621).ax1;
        ...
        (_b621)._min_ax12 = _augval638;
         /* _min_ay13 is min of ay1 */ var _augval643 = (_b621).ay1;
        ...
        (_b621)._min_ay13 = _augval643;
         /* _max_ay24 is max of ay2 */ var _augval648 = (_b621).ay2;
        ...
        if (!(((_b621)._parent9) == null)) {
         /* _min_ax12 is min of ax1 */ var _augval653 = ((_b621)._parent9).ax1;
        ...
        ((_b621)._parent9)._min_ax12 = _augval653;
         /* _min_ay13 is min of ay1 */ var _augval658 = ((_b621)._parent9).ay1;
        ...
        ((_b621)._parent9)._min_ay13 = _augval658;
         /* _max_ay24 is max of ay2 */ var _augval663 = ((_b621)._parent9).ay2;
...
RectangleHolder.prototype.updateAy2 = function(__x, new_val) {
    if ((__x).ay2 != new_val) {
         /* _max_ay24 is max of ay2 */ var _augval668 = new_val;
        ...
        var _old_height676 = (_cursor673)._height10;
         /* _max_ay24 is max of ay2 */ var _augval677 = (_cursor673).ay2;
...
RectangleHolder.prototype.update = function(__x, ax1, ay1, ax2, ay2) {
    ...
    _new_x685 = null;
     /* replace __x with _new_x685 in _parent682 */ if (!((_parent682) == null)) {
    ...
    var _mr691 = (_x687)._right8;
     /* replace _x687 with _mr691 in _mp690 */ if (!((_mp690) == null)) {
    ...
    (_mr691)._parent9 = _mp690;
     ...
     /* replace __x with _x687 in _parent682 */ if (!((_parent682) == null)) {
    if (((_parent682)._left7) == (__x)) {
    ...
    (_x687)._parent9 = _parent682;
     ...
     /* replace null with _left683 in _x687 */ (_x687)._left7 = _left683;
    if (!((_left683) == null)) {
    (_left683)._parent9 = _x687;
    }
     /* replace _mr691 with (__x)._right8 in _x687 */ (_x687)._right8 = (__x)._right8;
    if (!(((__x)._right8) == null)) {
    ((__x)._right8)._parent9 = _x687;
    }
     /* _min_ax12 is min of ax1 */ var _augval692 = (_x687).ax1;
    ...
    (_x687)._min_ax12 = _augval692;
     /* _min_ay13 is min of ay1 */ var _augval697 = (_x687).ay1;
    ...
    (_x687)._min_ay13 = _augval697;
     /* _max_ay24 is max of ay2 */ var _augval702 = (_x687).ay2;
    ...
    var _old_height712 = (_cursor707)._height10;
     /* _min_ax12 is min of ax1 */ var _augval713 = (_cursor707).ax1;
    ...
    (_cursor707)._min_ax12 = _augval713;
     /* _min_ay13 is min of ay1 */ var _augval718 = (_cursor707).ay1;
    ...
    (_cursor707)._min_ay13 = _augval718;
     /* _max_ay24 is max of ay2 */ var _augval723 = (_cursor707).ay2;
    ...
    var _old_height733 = (_cursor728)._height10;
     /* _min_ax12 is min of ax1 */ var _augval734 = (_cursor728).ax1;
    ...
    (_cursor728)._min_ax12 = _augval734;
     /* _min_ay13 is min of ay1 */ var _augval739 = (_cursor728).ay1;
    ...
    (_cursor728)._min_ay13 = _augval739;
     /* _max_ay24 is max of ay2 */ var _augval744 = (_cursor728).ay2;
    ...
    var _old_height757 = (_cursor752)._height10;
     /* _min_ax12 is min of ax1 */ var _augval758 = (_cursor752).ax1;
    ...
    (_cursor752)._min_ax12 = _augval758;
     /* _min_ay13 is min of ay1 */ var _augval763 = (_cursor752).ay1;
    ...
    (_cursor752)._min_ay13 = _augval763;
     /* _max_ay24 is max of ay2 */ var _augval768 = (_cursor752).ay2;
    ...
    _cursor752 = (_cursor752)._parent9;
     ...
     /* rebalance AVL tree */ var _cursor773 = __x;
    var _imbalance774;
    ...
    if ((((((_cursor773)._left7)._left7) == null) ? (-1) : ((((_cursor773)._left7)._left7)._height10)) < (((((_cursor773)._left7)._right8) == null) ? (-1) : ((((_cursor773)._left7)._right8)._height10))) {
     /* rotate ((_cursor773)._left7)._right8 */ var _a775 = (_cursor773)._left7;
    var _b776 = (_a775)._right8;
    var _c777 = (_b776)._left7;
     /* replace _a775 with _b776 in (_a775)._parent9 */ if (!(((_a775)._parent9) == null)) {
    ...
    (_b776)._parent9 = (_a775)._parent9;
     ...
     /* replace _c777 with _a775 in _b776 */ (_b776)._left7 = _a775;
    if (!((_a775) == null)) {
    (_a775)._parent9 = _b776;
    }
     /* replace _b776 with _c777 in _a775 */ (_a775)._right8 = _c777;
    if (!((_c777) == null)) {
    (_c777)._parent9 = _a775;
    }
     /* _min_ax12 is min of ax1 */ var _augval778 = (_a775).ax1;
    ...
    (_a775)._min_ax12 = _augval778;
     /* _min_ay13 is min of ay1 */ var _augval783 = (_a775).ay1;
    ...
    (_a775)._min_ay13 = _augval783;
     /* _max_ay24 is max of ay2 */ var _augval788 = (_a775).ay2;
    ...
    (_a775)._height10 = 1+((((((_a775)._left7) == null) ? (-1) : (((_a775)._left7)._height10)) > ((((_a775)._right8) == null) ? (-1) : (((_a775)._right8)._height10))) ? ((((_a775)._left7) == null) ? (-1) : (((_a775)._left7)._height10)) : ((((_a775)._right8) == null) ? (-1) : (((_a775)._right8)._height10)));
     /* _min_ax12 is min of ax1 */ var _augval793 = (_b776).ax1;
    ...
    (_b776)._min_ax12 = _augval793;
     /* _min_ay13 is min of ay1 */ var _augval798 = (_b776).ay1;
    ...
    (_b776)._min_ay13 = _augval798;
     /* _max_ay24 is max of ay2 */ var _augval803 = (_b776).ay2;
    ...
    if (!(((_b776)._parent9) == null)) {
     /* _min_ax12 is min of ax1 */ var _augval808 = ((_b776)._parent9).ax1;
    ...
    ((_b776)._parent9)._min_ax12 = _augval808;
     /* _min_ay13 is min of ay1 */ var _augval813 = ((_b776)._parent9).ay1;
    ...
    ((_b776)._parent9)._min_ay13 = _augval813;
     /* _max_ay24 is max of ay2 */ var _augval818 = ((_b776)._parent9).ay2;
    ...
    (this)._root1 = _b776;
     ...
     /* rotate (_cursor773)._left7 */ var _a823 = _cursor773;
    var _b824 = (_a823)._left7;
    var _c825 = (_b824)._right8;
     /* replace _a823 with _b824 in (_a823)._parent9 */ if (!(((_a823)._parent9) == null)) {
    ...
    (_b824)._parent9 = (_a823)._parent9;
     ...
     /* replace _c825 with _a823 in _b824 */ (_b824)._right8 = _a823;
    if (!((_a823) == null)) {
    (_a823)._parent9 = _b824;
    }
     /* replace _b824 with _c825 in _a823 */ (_a823)._left7 = _c825;
    if (!((_c825) == null)) {
    (_c825)._parent9 = _a823;
    }
     /* _min_ax12 is min of ax1 */ var _augval826 = (_a823).ax1;
    ...
    (_a823)._min_ax12 = _augval826;
     /* _min_ay13 is min of ay1 */ var _augval831 = (_a823).ay1;
    ...
    (_a823)._min_ay13 = _augval831;
     /* _max_ay24 is max of ay2 */ var _augval836 = (_a823).ay2;
    ...
    (_a823)._height10 = 1+((((((_a823)._left7) == null) ? (-1) : (((_a823)._left7)._height10)) > ((((_a823)._right8) == null) ? (-1) : (((_a823)._right8)._height10))) ? ((((_a823)._left7) == null) ? (-1) : (((_a823)._left7)._height10)) : ((((_a823)._right8) == null) ? (-1) : (((_a823)._right8)._height10)));
     /* _min_ax12 is min of ax1 */ var _augval841 = (_b824).ax1;
    ...
    (_b824)._min_ax12 = _augval841;
     /* _min_ay13 is min of ay1 */ var _augval846 = (_b824).ay1;
    ...
    (_b824)._min_ay13 = _augval846;
     /* _max_ay24 is max of ay2 */ var _augval851 = (_b824).ay2;
    ...
    if (!(((_b824)._parent9) == null)) {
     /* _min_ax12 is min of ax1 */ var _augval856 = ((_b824)._parent9).ax1;
    ...
    ((_b824)._parent9)._min_ax12 = _augval856;
     /* _min_ay13 is min of ay1 */ var _augval861 = ((_b824)._parent9).ay1;
    ...
    ((_b824)._parent9)._min_ay13 = _augval861;
     /* _max_ay24 is max of ay2 */ var _augval866 = ((_b824)._parent9).ay2;
    ...
    if ((((((_cursor773)._right8)._left7) == null) ? (-1) : ((((_cursor773)._right8)._left7)._height10)) > (((((_cursor773)._right8)._right8) == null) ? (-1) : ((((_cursor773)._right8)._right8)._height10))) {
     /* rotate ((_cursor773)._right8)._left7 */ var _a871 = (_cursor773)._right8;
    var _b872 = (_a871)._left7;
    var _c873 = (_b872)._right8;
     /* replace _a871 with _b872 in (_a871)._parent9 */ if (!(((_a871)._parent9) == null)) {
    ...
    (_b872)._parent9 = (_a871)._parent9;
     ...
     /* replace _c873 with _a871 in _b872 */ (_b872)._right8 = _a871;
    if (!((_a871) == null)) {
    (_a871)._parent9 = _b872;
    }
     /* replace _b872 with _c873 in _a871 */ (_a871)._left7 = _c873;
    if (!((_c873) == null)) {
    (_c873)._parent9 = _a871;
    }
     /* _min_ax12 is min of ax1 */ var _augval874 = (_a871).ax1;
    ...
    (_a871)._min_ax12 = _augval874;
     /* _min_ay13 is min of ay1 */ var _augval879 = (_a871).ay1;
    ...
    (_a871)._min_ay13 = _augval879;
     /* _max_ay24 is max of ay2 */ var _augval884 = (_a871).ay2;
    ...
    (_a871)._height10 = 1+((((((_a871)._left7) == null) ? (-1) : (((_a871)._left7)._height10)) > ((((_a871)._right8) == null) ? (-1) : (((_a871)._right8)._height10))) ? ((((_a871)._left7) == null) ? (-1) : (((_a871)._left7)._height10)) : ((((_a871)._right8) == null) ? (-1) : (((_a871)._right8)._height10)));
     /* _min_ax12 is min of ax1 */ var _augval889 = (_b872).ax1;
    ...
    (_b872)._min_ax12 = _augval889;
     /* _min_ay13 is min of ay1 */ var _augval894 = (_b872).ay1;
    ...
    (_b872)._min_ay13 = _augval894;
     /* _max_ay24 is max of ay2 */ var _augval899 = (_b872).ay2;
    ...
    if (!(((_b872)._parent9) == null)) {
     /* _min_ax12 is min of ax1 */ var _augval904 = ((_b872)._parent9).ax1;
    ...
    ((_b872)._parent9)._min_ax12 = _augval904;
     /* _min_ay13 is min of ay1 */ var _augval909 = ((_b872)._parent9).ay1;
    ...
    ((_b872)._parent9)._min_ay13 = _augval909;
     /* _max_ay24 is max of ay2 */ var _augval914 = ((_b872)._parent9).ay2;
    ...
    (this)._root1 = _b872;
     ...
     /* rotate (_cursor773)._right8 */ var _a919 = _cursor773;
    var _b920 = (_a919)._right8;
    var _c921 = (_b920)._left7;
     /* replace _a919 with _b920 in (_a919)._parent9 */ if (!(((_a919)._parent9) == null)) {
    ...
    (_b920)._parent9 = (_a919)._parent9;
     ...
     /* replace _c921 with _a919 in _b920 */ (_b920)._left7 = _a919;
    if (!((_a919) == null)) {
    (_a919)._parent9 = _b920;
    }
     /* replace _b920 with _c921 in _a919 */ (_a919)._right8 = _c921;
    if (!((_c921) == null)) {
    (_c921)._parent9 = _a919;
    }
     /* _min_ax12 is min of ax1 */ var _augval922 = (_a919).ax1;
    ...
    (_a919)._min_ax12 = _augval922;
     /* _min_ay13 is min of ay1 */ var _augval927 = (_a919).ay1;
    ...
    (_a919)._min_ay13 = _augval927;
     /* _max_ay24 is max of ay2 */ var _augval932 = (_a919).ay2;
    ...
    (_a919)._height10 = 1+((((((_a919)._left7) == null) ? (-1) : (((_a919)._left7)._height10)) > ((((_a919)._right8) == null) ? (-1) : (((_a919)._right8)._height10))) ? ((((_a919)._left7) == null) ? (-1) : (((_a919)._left7)._height10)) : ((((_a919)._right8) == null) ? (-1) : (((_a919)._right8)._height10)));
     /* _min_ax12 is min of ax1 */ var _augval937 = (_b920).ax1;
    ...
    (_b920)._min_ax12 = _augval937;
     /* _min_ay13 is min of ay1 */ var _augval942 = (_b920).ay1;
    ...
    (_b920)._min_ay13 = _augval942;
     /* _max_ay24 is max of ay2 */ var _augval947 = (_b920).ay2;
    ...
    if (!(((_b920)._parent9) == null)) {
     /* _min_ax12 is min of ax1 */ var _augval952 = ((_b920)._parent9).ax1;
    ...
    ((_b920)._parent9)._min_ax12 = _augval952;
     /* _min_ay13 is min of ay1 */ var _augval957 = ((_b920)._parent9).ay1;
    ...
    ((_b920)._parent9)._min_ay13 = _augval957;
     /* _max_ay24 is max of ay2 */ var _augval962 = ((_b920)._parent9).ay2;
...
RectangleHolder.prototype.findMatchingRectangles = function(bx1, by1, bx2, by2, __callback) {
    ...
    if (_descend969) {
     /* too small? */ if ((false) || (((_x968).ax2) <= (bx1))) {
    ...
    _x968 = (_x968)._parent9;
     ...
     /* node ok? */ } else if ((((true) && (((_x968).ax1) < (bx2))) && (((_x968).ay1) < (by2))) && (((_x968).ay2) > (by1))) {
    break;
    } else if ((_x968) == (_root967)) {
    _root967 = (_x968)._right8;
    _x968 = (_x968)._right8;
    ...
    for (;;) {
        ...
        var _name971 = _cursor6;
         /* ADVANCE */ _prev_cursor5 = _cursor6;
        do {
        ...
        if (_descend975) {
         /* too small? */ if ((false) || (((_x974).ax2) <= (bx1))) {
        ...
        _x974 = (_x974)._parent9;
         ...
         /* node ok? */ } else if ((((true) && (((_x974).ax1) < (bx2))) && (((_x974).ay1) < (by2))) && (((_x974).ay2) > (by1))) {
        break;
        } else if ((_x974) == (_root973)) {
        _root973 = (_x974)._right8;
        _x974 = (_x974)._right8;
        ...
        _new_x981 = null;
         /* replace _to_remove977 with _new_x981 in _parent978 */ if (!((_parent978) == null)) {
        ...
        var _mr987 = (_x983)._right8;
         /* replace _x983 with _mr987 in _mp986 */ if (!((_mp986) == null)) {
        ...
        (_mr987)._parent9 = _mp986;
         ...
         /* replace _to_remove977 with _x983 in _parent978 */ if (!((_parent978) == null)) {
        if (((_parent978)._left7) == (_to_remove977)) {
        ...
        (_x983)._parent9 = _parent978;
         ...
         /* replace null with _left979 in _x983 */ (_x983)._left7 = _left979;
        if (!((_left979) == null)) {
        (_left979)._parent9 = _x983;
        }
         /* replace _mr987 with (_to_remove977)._right8 in _x983 */ (_x983)._right8 = (_to_remove977)._right8;
        if (!(((_to_remove977)._right8) == null)) {
        ((_to_remove977)._right8)._parent9 = _x983;
        }
         /* _min_ax12 is min of ax1 */ var _augval988 = (_x983).ax1;
        ...
        (_x983)._min_ax12 = _augval988;
         /* _min_ay13 is min of ay1 */ var _augval993 = (_x983).ay1;
        ...
        (_x983)._min_ay13 = _augval993;
         /* _max_ay24 is max of ay2 */ var _augval998 = (_x983).ay2;
        ...
        var _old_height1008 = (_cursor1003)._height10;
         /* _min_ax12 is min of ax1 */ var _augval1009 = (_cursor1003).ax1;
        ...
        (_cursor1003)._min_ax12 = _augval1009;
         /* _min_ay13 is min of ay1 */ var _augval1014 = (_cursor1003).ay1;
        ...
        (_cursor1003)._min_ay13 = _augval1014;
         /* _max_ay24 is max of ay2 */ var _augval1019 = (_cursor1003).ay2;
        ...
        var _old_height1029 = (_cursor1024)._height10;
         /* _min_ax12 is min of ax1 */ var _augval1030 = (_cursor1024).ax1;
        ...
        (_cursor1024)._min_ax12 = _augval1030;
         /* _min_ay13 is min of ay1 */ var _augval1035 = (_cursor1024).ay1;
        ...
        (_cursor1024)._min_ay13 = _augval1035;
         /* _max_ay24 is max of ay2 */ var _augval1040 = (_cursor1024).ay2;
