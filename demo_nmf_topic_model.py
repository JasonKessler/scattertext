...
sentences_for_topic_modeling = st.SentencesForTopicModeling(unigram_corpus)
pipeline = Pipeline([
    ('tfidf', TfidfTransformer(sublinear_tf=True)),
    ('nmf', (NMF(n_components=100, l1_ratio=.5, random_state=0)))
])
topic_model = sentences_for_topic_modeling.get_topics_from_model(
    pipe=pipeline,
